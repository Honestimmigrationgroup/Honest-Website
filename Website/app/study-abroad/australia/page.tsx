...
const whyStudyAustralia = [
  {
    ...
    description: "8 Australian Universities among world's top 100",
  },
  {
    icon: <DollarSign className="w-6 h-6 text-orange-600" />,
    title: "Stable Economy",
    description: "One of the world's most stable economies",
  },
  {
    icon: <Globe className="w-6 h-6 text-orange-600" />,
    title: "4 Years Work Visa",
    description: "Post-study work visa up to 4 years",
  },
  {
    icon: <CheckCircle className="w-6 h-6 text-orange-600" />,
    title: "High Scholarships",
    description: "High probability for PG and Research programs",
  },
]
...
const universities = [
  ...
  { name: "University of New South Wales (UNSW)", location: "Sydney" },
  ...
  { name: "University of Adelaide", location: "Adelaide" },
  { name: "Australia National University", location: "Canberra" },
]
...
const programs = [
  {
    ...
    overview: "Comprehensive IT programs covering modern technologies, cybersecurity, and artificial intelligence.",
    universities: [
  ...
  },
  {
    ...
    overview: "World-class engineering programs with high demand in Australia's mining and infrastructure sectors.",
    universities: [
      "University of Melbourne",
      "Monash University",
      "University of New South Wales (UNSW)",
  ...
  },
  {
    ...
    overview: "Advanced pharmacy programs with excellent career opportunities in Australia's healthcare sector.",
    universities: [
      "University of Melbourne",
      "Monash University",
      "University of Sydney",
  ...
  },
  {
    title: "Biotechnology",
    icon: <Zap className="w-8 h-8" />,
    overview: "Cutting-edge biotechnology programs focusing on innovation in life sciences and medical research.",
    universities: [
      "University of Melbourne",
      "Monash University",
      "University of Sydney",
...
const processSteps = [
  ...
  { step: 4, title: "Scholarship Assessment", icon: <DollarSign className="w-6 h-6" /> },
  { step: 5, title: "Health Insurance", icon: <Heart className="w-6 h-6" /> },
...
const admissionChecklist = [
  ...
  "Degree Certificate",
  "IELTS/PTE/TOEFL Test Score Sheet",
...
export default function StudyInAustralia() {
  ...
  useEffect(() => {
    ...
    const whyInterval = setInterval(() => {
      setCurrentWhySlide((prev) => (prev + 1) % whyStudyAustralia.length)
  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      <section className="relative bg-white text-gray-800 section-padding" style={{ padding: "80px 0" }}>
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="hero-title-responsive font-bold mb-12">
            ...
            <span className="hero-title-2 block text-orange-600 font-black">Australia</span>
          </h1>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="btn-primary bg-orange-600 text-white hover:bg-orange-700">
              Start Your Journey
            ...
            <button
              ...
              className="btn-primary bg-white text-orange-600 border border-orange-600 hover:bg-orange-600 hover:text-white"
            >
      ...
      {/* Why Study in Australia - Mobile Carousel */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="md:hidden">
              ...
              <div className="w-80 mx-4">
                <article className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 text-center h-full transition-all duration-500 ease-in-out">
                  <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <div className="text-orange-500">{whyStudyAustralia[currentWhySlide].icon}</div>
                  </div>
                  <h3 className="font-bold mb-3 text-gray-800 text-lg">{whyStudyAustralia[currentWhySlide].title}</h3>
                  <p className="text-sm text-gray-600 leading-relaxed">
                    {whyStudyAustralia[currentWhySlide].description}
                  </p>
                </article>
              </div>
            </div>
            ...
            <div className="flex justify-center mt-4 space-x-2">
              {whyStudyAustralia.map((_, index) => (
                <div
                  key={index}
                  className={`w-2 h-2 rounded-full transition-colors duration-300 ${
                    index === currentWhySlide ? "bg-orange-600" : "bg-gray-300"
                  }`}
                />
              ))}
            </div>
          ...
          <div className="flex justify-between items-center mb-12">
            <div>
              <h2 className="section-title animate-on-scroll">
                Group of Eight <span className="text-orange-600">Universities</span>
              </h2>
              <p className="section-subtitle animate-on-scroll">Australia's leading institutes</p>
            </div>
            <button
                  ...
                  <div key={slideIndex} className="w-full flex-shrink-0">
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                      {universities.slice(slideIndex * 4, slideIndex * 4 + 4).map((university, index) => (
                        <div
                          key={index}
                          className="bg-orange-600 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 p-6 text-white"
                        >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="section-title animate-on-scroll text-white">
              Popular <span className="text-orange-600">Programs</span>
            </h2>
          ...
          <div className="relative animate-on-scroll">
            <div className="overflow-hidden">
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                      {programs.slice(slideIndex * 3, slideIndex * 3 + 3).map((program, index) => (
                        <div key={index} className="group relative">
                          <div className="card p-8 h-full bg-gray-800 border border-gray-700 text-white hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:border-orange-500">
                            <div className="flex items-center gap-4 mb-6">
                              <div className="p-3 bg-orange-600/20 rounded-lg backdrop-blur-sm text-orange-500">
                                {program.icon}
                              </div>
                            ...
                            <div className="space-y-3">
                              <button
                                ...
                                className="w-full btn-primary bg-orange-600 hover:bg-orange-700 text-white"
                              >
                              ...
                              <button
                                ...
                                className="w-full btn-outline border-gray-600 text-gray-300 hover:bg-gray-700 hover:border-orange-500"
                              >
                              ...
                              <Link
                                href="/contact"
                                className="w-full btn-primary bg-orange-600 hover:bg-orange-700 text-white flex items-center justify-center"
                              >
              ...
              <div className="flex justify-center mt-8 gap-4">
                <button
                  onClick={() => setCurrentProgramSlide(Math.max(0, currentProgramSlide - 1))}
                  disabled={currentProgramSlide === 0}
                  className="flex items-center gap-2 px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
                >
                ...
                <button
                  onClick={() =>
                    setCurrentProgramSlide(Math.min(Math.ceil(programs.length / 3) - 1, currentProgramSlide + 1))
                  }
                  disabled={currentProgramSlide === Math.ceil(programs.length / 3) - 1}
                  className="flex items-center gap-2 px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
                >
                  Next
      ...
      <section className="section-padding bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="section-title animate-on-scroll">
              Your Path to <span className="text-orange-600">Australia</span>
            </h2>
            ...
            <div className="card p-8">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <div className="text-2xl font-bold text-green-600">AUD $25,000 - $45,000</div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl max-w-2xl w-full max-h-[80vh] overflow-hidden">
            <div className="flex items-center justify-between p-6 border-b">
              <h3 className="text-2xl font-bold text-gray-800">Group of Eight Universities</h3>
              <button
